...
sys.path.insert(1, './python-imagesearch')

from imagesearch import imagesearch

box = (1161,71,1718,1026) #Android screen coordinates
ball_box = (1295,96,87,887) #(left, top, width, height)
try:
...
while True:
	...
	try:
		x, y = pyautogui.locateCenterOnScreen("./mini_ball.png", confidence=0.6 , region=ball_box)
		print(x,y)
		if y > 600:
			pyautogui.click(1226, 937)
	except Exception as e:
		pass

	# pos = imagesearch("../mini_ball.png")
	# if pos[0] != -1:
	# 	cv2.circle(screen, pos,10,(0, 0, 255))
